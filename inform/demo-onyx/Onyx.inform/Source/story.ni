...
A creature is a kind of thing.
A mouse is a kind of device. A mouse is undescribed.


Instead of doing anything to the mouse: say "STEP OFF M8"

The tree and a fence are scenery in The Deep Forest.
The tiny mouse is a mouse in The Deep Forest.
Report taking when location is The Deep Forest: say "[the noun] EXPLODES AND YOU DIE HAHAHAHA"

After jumping: now every mouse is switched on; say "Yeah, you did that once as a kid, on accident. Not 	happening again."

The description of the mouse is "WHAT ARE YOU LOOKIN AT [number of creatures] PUNK [if mouse is held] LETME GO [end if]"

Every turn when a mouse is switched on: say "HI"
